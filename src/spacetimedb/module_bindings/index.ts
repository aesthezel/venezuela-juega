...
const tablesSchema = __schema({
  firefly: __table({
    name: 'firefly',
    indexes: [
      { accessor: 'firefly_location', name: 'firefly_location_idx_btree', algorithm: 'btree', columns: [
        'location',
      ] },
  ...
  gameStats: __table({
    name: 'game_stats',
    indexes: [
      { accessor: 'gameSlug', name: 'game_stats_game_slug_idx_btree', algorithm: 'btree', columns: [
        'gameSlug',
      ] },
    ],
    constraints: [
      { name: 'game_stats_game_slug_key', constraint: 'unique', columns: ['gameSlug'] },
    ],
  }, GameStatsRow),
  myActivity: __table({
    name: 'my_activity',
    indexes: [
      { accessor: 'id', name: 'my_activity_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
      { accessor: 'my_activity_player', name: 'my_activity_player_id_idx_btree', algorithm: 'btree', columns: [
        'playerId',
      ] },
    ],
    constraints: [
      { name: 'my_activity_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, MyActivityRow),
  profile: __table({
    name: 'profile',
