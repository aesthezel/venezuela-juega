                ...
                <div className="max-w-2xl w-full text-center space-y-12">
                    ...
                    <div className="space-y-6">
                        <div className="flex justify-center">
                            <div className="w-24 h-24 bg-surface-800 rounded-3xl flex items-center justify-center text-accent-teal shadow-2xl border border-white/5 relative group">
                        ...
                        <div className="space-y-3">
                            <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight">
                                Ups... Esta ubicación <span className="text-accent-teal">no existe</span>
                            </h1>
                    ...
                    {randomGame && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
                            <div className="flex items-center justify-center gap-3 text-xs font-black uppercase tracking-[0.2em] text-accent-teal-dark/70">
                                <div className="w-8 h-[1px] bg-accent-teal-dark/30" />
                            ...
                            <div className="max-w-sm mx-auto group">
                                ...
                                {/* <button
                                    ...
                                    className="mt-4 flex items-center gap-2 mx-auto text-surface-500 hover:text-accent-teal transition-colors text-sm font-bold bg-surface-800/50 hover:bg-surface-800 px-4 py-2 rounded-full border border-white/5"
                                >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                        <button
                            ...
                            className="w-full sm:w-auto px-8 py-4 bg-white text-surface-950 font-black rounded-2xl hover:bg-accent-teal transition-all duration-300 shadow-xl flex items-center justify-center gap-3 group"
                        >
