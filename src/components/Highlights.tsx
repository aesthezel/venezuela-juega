                ...
                {hasMultipleGames && (
                    <>
                        <button
                            ...
                            className="absolute top-1/2 left-0 md:-left-4 transform -translate-y-1/2 z-10 bg-base-300/60 hover:bg-base-300/90 rounded-full p-2 transition-all text-white opacity-0 group-hover:opacity-100 focus:opacity-100"
                        ...
                        <button
                            onClick={goToNext}
                            className="absolute top-1/2 right-0 md:-right-4 transform -translate-y-1/2 z-10 bg-base-300/60 hover:bg-base-300/90 rounded-full p-2 transition-all text-white opacity-0 group-hover:opacity-100 focus:opacity-100"
                        ...
                        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2 z-10">
                            {highlightedGames.map((_, index) => (
                                <button
                                    ...
                                    className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${currentIndex === index ? 'bg-accent-teal' : 'bg-base-300/80 hover:bg-base-300'}`}
